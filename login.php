...
<div class="md:flex md:items-center mb-6 mt-6">
    ...
    <div class="md:w-2/3">
      <input x-model="username" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" placeholder="Jane Doe">
    </div>
  </div>
  <div class="md:flex md:items-center mb-6">
    ...
    <div class="md:w-2/3">
      <input x-model="password" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-username" type="password" placeholder="******************">
    </div>
  </div>
...
function submitLogin (param1, param2) {
  const formData = new FormData();
  // const baseUrl = window.location.origin + '/smallBlog';

  formData.append('username', param1);
