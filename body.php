...
<div id="mySidenav" class="sidenav bg-teal-500">
  ...
  <div class="mx-auto p-4" >
    <div class="flex flex-wrap justify-center">
      ...
      <img class="border-b border-t border-l border-r border-gray-400 h-48 lg:h-auto lg:w-48 bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" x-bind:src="listData[index].img" alt="Sunset in the mountains">
